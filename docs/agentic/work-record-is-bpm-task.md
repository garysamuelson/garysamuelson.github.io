...
![Work Record Anatomy — identity, state, actions, policies, owner](../assets/images/work_record_anatomy_v1.svg)

Jones calls this the trillion-dollar opportunity: the value sitting in enterprise
